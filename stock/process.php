...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['inputText']) && isset($_POST['at1']) && isset($_POST['at4']) && isset($_POST['at7']) && isset($_POST['at3']) && isset($_POST['at8'])) {
    ...
    $resultado = buscaItem($inputText,$at1,$at3,$at4,$at7,$at8);
...
echo "<div class='descImg'>";
    echo "<ul class='list-group'>";
       ...
       echo "</li>";  
    echo "</ul>";
    echo "<a href='carrusel.php?coditm=$coditm' target='_blank'>";
...
function buscaItem($texto,$atr1,$atr3,$atr4,$atr7,$atr8) {
    
    include_once "config.php";
    $sql = "[FAM450].[dbo].[AP_BuscaItem2] '$texto','$atr1','$atr3','$atr4','$atr7','$atr8'";
    $params = array();
