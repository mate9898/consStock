...
//genero la consulta de datos detalles
...
while ($row = sqlsrv_fetch_array($stmt2))  {
    ...
    $curva[] = array('precio'=> $precio,'lista'=> $lista,'marca' => $marca,'tipoventa' => $tipoventa, 'disciplina' => $disciplina,
                    'genero'=> $genero, 'coditmalernativo' => $coditmalternativo, 'codtal'=> $talle, 'equivalencia'=> $equiv);                   
}
    ...
    <main class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div col-12>
                    ...
                    echo "<div class='box'><strong>Precio: &nbsp <span> </span>" . $curva[0]['precio'] ."</strong></div>";
                    echo "<div class='box'><strong>Lista: &nbsp <span> </span></strong>" . $curva[0]['lista'] ."</div>";
                    echo "<div class='box'><strong>Tipo Venta: &nbsp <span> </span></strong>" . $curva[0]['tipoventa'] ."</div>";
                    echo"<div class='box'><strong>Marca: &nbsp <span> </span></strong>"  . $curva[0]['marca'] ."</div>";
                    echo"<div class='box'><strong>Disciplina: &nbsp <span> </span></strong>"  . $curva[0]['disciplina'] ."</div>";
                    echo"<div class='box'><strong>Genero: &nbsp <span> </span></strong>"  . $curva[0]['genero'] ."</div>";
                    echo "</div>";
