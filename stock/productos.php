...
<body>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="background-color:#D9000D; height: 60px; width: 100%; text-align: center;">
                    <a href="<?= htmlspecialchars($curva[0]['url'] ?? '#', ENT_QUOTES, 'UTF-8'); ?>" style="text-decoration: none;" target="_blank">
    ...
    <div id="carouselfoto" class="carousel slide" data-bs-theme="dark" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php if (empty($imagenes)) : ?>
                <div class="p-3 text-center text-muted">Sin imágenes disponibles para este producto.</div>
            <?php endif; ?>
            <?php foreach ($imagenes as $index => $ruta): ?>
                <?php
                    ...
                    // Forzar https si llega como http
