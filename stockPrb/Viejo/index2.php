    ...
    <main class="container-fluid">
        <div class="row justify-content-center">
            ...
            <form class="menu">
                    ...
                    <label for="at8" class="atributo">Disciplina
                        <?php
                            //genero la consulta at8
                            $sql = "SELECT  rtrim(CODATRVAL) as valor, DESCRIPCION FROM dbo.ATRIBUTOSVAL WHERE  (CODATR = '008') order by CODATRVAL";
                            $params = array();
                            $options =  array("Scrollable" => SQLSRV_CURSOR_KEYSET);
                            $stmt = sqlsrv_query($conn, $sql, $params, $options);
                            ...
                            $menu = "<select  class='select' name='at8'  id='at8'>\n";
                            $menu .= "\n<option value=''></option>";
