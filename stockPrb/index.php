    ...
    <main class="container-fluid">
        <div class="row justify-content-center">
            ...
            <form class="menu">
                ...
                <div class="filters-row filters-card-search-row">
                    <div class="filter-field filter-field-search">
                        <span class="filter-label">Búsqueda</span>
                        <div class="search-wrapper">
                            <input type="text" id="inputText" placeholder="Código o descripción del producto">
                            <i class="bi bi-search search-icon"></i>
                        </div>
                    </div>
                    <div class="filter-field filter-field-sucursal">
                        ...
                        <div class="sucursal-select-container">
                            ...
                            <div id="sucursalesSelected" class="selected-tags-container-sucursal empty">
                                <span class="selected-tags-placeholder">Ninguna seleccionada</span>
                            </div>
                        </div>
                        </div>
                    </div>
                ...
                <!-- Separador con etiqueta FILTROS -->
                <div class="filters-separator">
                    <span class="filters-separator-label">Filtros</span>
                    <span class="filters-separator-line"></span>
                </div>
                
                <!-- Primera fila de filtros: Atributo, Marca, Disciplina -->
                <div class="filters-row filters-row-center filters-row-3col">
                    <div class="filter-field">
                        <label for="at1_text" class="filter-label">Atributo</label>
                        <div class="marca-select-container filter-input-with-icon">
                            <i class="bi bi-tag-fill filter-input-icon"></i>
                            <?php
                                $sql = "SELECT RTRIM(CODATRVAL) as valor, DESCRIPCION
                                        FROM dbo.ATRIBUTOSVAL
                                        WHERE CODATR = '001'
                                        ORDER BY CODATRVAL";
                                printPredictiveFromSql($conn, $sql, 'at1', 'at1', 'Calzado, Indumentaria');
                            ?>
                        </div>
                    </div>
                    <div class="filter-field">
                        <label for="at4_text" class="filter-label">Marca</label>
                        <div class="marca-select-container filter-input-with-icon">
                            <i class="bi bi-star-fill filter-input-icon"></i>
                            <?php
                                $sql = "[FAM450].[dbo].[SP_MarcasStockWeb]";
                                printPredictiveFromSql($conn, $sql, 'at4', 'at4', 'Adidas, Fila');
                            ?>
                    ...
                    <div class="filter-field">
                        <label for="at8_text" class="filter-label">Disciplina</label>
                        <div class="marca-select-container filter-input-with-icon">
                            <i class="bi bi-trophy-fill filter-input-icon"></i>
                            <?php
                                $sql = "SELECT RTRIM(CODATRVAL) as valor, DESCRIPCION
                                        FROM dbo.ATRIBUTOSVAL
                                        WHERE CODATR = '008'
                                        ORDER BY CODATRVAL";
                                printPredictiveFromSql($conn, $sql, 'at8', 'at8', 'Running, Fútbol');
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="filters-row filters-row-center filters-row-2col">
                    <div class="filter-field">
                        <label for="at7_text" class="filter-label">Promoción</label>
                        <div class="marca-select-container filter-input-with-icon">
                            <i class="bi bi-percent filter-input-icon"></i>
                            <?php
                                $sql = "SELECT RTRIM(CODATRVAL) as valor, DESCRIPCION
                                        FROM dbo.ATRIBUTOSVAL
                                        WHERE CODATR = '007'
                                        ORDER BY CODATRVAL";
                                printPredictiveFromSql($conn, $sql, 'at7', 'at7', '2x1, Descuento');
                            ?>
                        </div>
                    </div>
                    <div class="filter-field">
                        <label for="at3_text" class="filter-label">Género</label>
                        <div class="marca-select-container filter-input-with-icon">
                            <i class="bi bi-person-fill filter-input-icon"></i>
                            <?php
                                $sql = "SELECT RTRIM(CODATRVAL) as valor, DESCRIPCION
                                        FROM dbo.ATRIBUTOSVAL
                                        WHERE CODATR = '003'
                                        ORDER BY DESCRIPCION";
                                printPredictiveFromSql($conn, $sql, 'at3', 'at3', 'Hombre, Mujer');
                            ?>
                        </div>
                    </div>
                </div> 
